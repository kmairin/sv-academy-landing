...
var translations = {
  ...
  th: {
    ...
    mentors_label: "ที่ปรึกษาของคุณ", mentors_title: "สอนโดยวิศวกรจาก Silicon Valley",
    dot_prom: "พรหม", dot_march: "March", dot_charlie: "Charlie",
    prom_role: "Creative Director & Operations Lead",
    prom_tag2: "ผู้ช่วยผู้อำนวยการ", prom_tag4: "Graphic Design",
    prom_bio: "ผู้ช่วยผู้อำนวยการโรงเรียนเลิศหล้า จบปริญญาตรีด้าน Graphic Communication & Design จาก University of Sunderland, UK คุณพรหมดูแล Promotional Strategy, Application Design และ สอนนักเรียนใช้ AI Design Tools ในชั้นเรียน",
    march_role: "Technical Lead",
    march_bio: "Senior Software Engineer ที่ Magic Eden ซานฟรานซิสโก เชี่ยวชาญด้าน Web3, Distributed Systems และ Product Engineering เคยทำงานที่ Uniswap Labs, Amazon และ Databricks จบจากจุฬาลงกรณ์ ปริญญาโท Johns Hopkins มาสอนด้วยตัวเองที่กรุงเทพฯ ครบทุก 5 สัปดาห์",
    charlie_role: "Infrastructure & Backend",
    charlie_bio: "Senior Software Engineer ที่ Robinhood เคยสร้าง Autonomous Delivery System ที่ Google X Wing และ Hyper-scale Infrastructure ที่ Meta เชี่ยวชาญด้าน Backend, Infrastructure และ System Architecture ดูแล Technical Architecture และโค้ช Demo Day มาสอนด้วยตัวเองทุกสัปดาห์",
    ...
    tool1_desc: "เปลี่ยนไอเดียให้เป็นหน้าตาแอปสวยๆ ด้วย AI แค่บอกว่าอยากได้แบบไหน ปรับแต่งจนพอใจ ไม่ต้องรู้ Figma",
    tool2_name: "Claude Code", tool2_sub: "สร้างแอป",
    tool2_desc: "AI เขียนโค้ดคู่กับคุณ เปลี่ยน design เป็นแอปที่ใช้งานได้จริง ใช้ NextJS, NestJS, TypeScript เหมือนบริษัทเทคจริงๆ",
    ...
    reels_sub: "ทำความรู้จักกับเราก่อนตัดสินใจ"
  }
};
...
(function() {
  ...
  function snap() {
    slider.style.transform = 'translateX(' + (-current * SLIDE_W) + 'px)';
    updateDots();
    updateArrows();
  }
  ...
  function initTouch() {
    ...
    slider.addEventListener('touchmove', function(e) {
      ...
      if (!isHoriz) return;
      diffX=dx;
      slider.style.transform='translateX('+(-current*SLIDE_W+diffX)+'px)';
    }, { passive: true });
  ...
  function initMouse() {
    ...
    document.addEventListener('mousemove', function(e) {
      if (!mDown) return;
      mDiffX=e.clientX-mStartX;
      slider.style.transform='translateX('+(-current*SLIDE_W+mDiffX)+'px)';
    });
